                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    <!-- Greeting -->
                                    <h1 style="{{ $style['header-1'] }}">Hello Admin,</h1>

                                    <p><b>First Name:</b>  {{ $input['first_name']}} </p> <br/>

                                    <p><b>Last Name:</b> {{ $input['last_name']}} </p> <br/>

                                    <p><b>Email:</b>  {{ $input['email']}} </p> <br/>

                                    <p><b>Phone:</b> {{ $input['phone']}} </p> <br/>

                                    <p><b>Message:</b> {{ $input['message']}} </p> <br/>
                                        ...
                                        <tr>
                                            <td style="{{ $fontFamily }}">
                                                ...
                                                <p style="{{ $style['paragraph-sub'] }}">If you can’t make your
                                                    appointment, please call MCN
                                                    at {{ (string)\Config::get('app.mts_phone') }} or email <a
                                                            href="{{ (string)\Config::get('app.mts_email') }}">{{ (string)\Config::get('app.mts_email') }}</a>
                                                </p>
                                                </p>
                                            </td>
                                        </tr>
