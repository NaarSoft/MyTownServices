...
<p>My Town Services offers residents of Montcalm Country with an arrayservicesat each of convenient locations.</p><br/><br/>
   ...
   <div class="col-md-2">
  <img class="underline-img" src="{{ asset('public/assets/images/locatoin-icon.png')}}" >
   </div>
     <div class="col-md-10">
   ...
   <div class="row">
	...
	<div class="row">
	<div class="col-md-4">
	<img class="underline-img" src="{{ asset('public/assets/images/locatoin-icon.png')}}" style="
    border: 1px solid;
    padding: 10px;
