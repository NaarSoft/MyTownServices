...
@elseif(is_null($serviceId))
    <div class="item form-group required">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text($response_table_name.'name', isset($response->name) ? $response->name : '', array('id'=>'name', 'class' => 'form-control col-md-7 col-xs-12', 'required', 'data-parsley-trigger'=>'blur', 'data-parsley-required-message' => 'Enter Name.', 'data-parsley-maxlength'=> 100, 'data-parsley-maxlength-message'=> 'Name may be up to 100 characters in length.'))!!}
        </div>
    </div>
    <div class="item form-group required">
        {{ Form::label('email_address', 'Email address', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12', 'for'=> 'email_address' )) }}
        <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::email($response_table_name.'email_address', isset($response->email_address) ? $response->email_address : '', array('id'=>'email_address', 'class' => 'form-control col-md-7 col-xs-12', 'required','data-parsley-trigger'=>'blur', 'data-parsley-required-message' => 'Enter Email address.', 'data-parsley-maxlength'=> 100, 'data-parsley-maxlength-message'=> 'Email address may be up to 100 characters in length.', 'data-parsley-type-message' => 'Enter valid Email address.' ))!!}
        </div>
    </div>
    <div class="item form-group required">
