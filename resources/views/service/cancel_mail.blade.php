                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        The Following appointment on <b> {{ $booking_date }} </b> with My town Services has been cancelled.
                                    </p>
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        Please visit us again at <a style="{{ $style['anchor'] }}" href="{{ config('app.url') }}"
                                                                    target="_blank">MyTownServices.org</a> if you wish to reschedule.
                                    </p>
                                    ...
                                    <table style="{{ $style['body_sub'] }}">
                                        <tr>
                                            <td style="{{ $fontFamily }}">
                                                ...
                                                <p style="{{ $style['paragraph-sub'] }}">For more info, please email <a
                                                            href="mailto:{{ (string)\Config::get('app.mts_email') }}">{{ (string)\Config::get('app.mts_email') }}</a>
                                                </p>
                                                </p>
                                            </td>
                                        </tr>
