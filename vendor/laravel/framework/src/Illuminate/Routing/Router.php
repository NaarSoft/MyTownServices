...
class Router implements RegistrarContract
{
    ...
    public function auth()
    {
        ...
        $this->get('password/set', 'Auth\ForgotPasswordController@showLinkRequestForm')->name('password.setrequest');
        $this->get('password/set/{token}', 'Auth\ResetPasswordController@showSetPasswordForm')->name('password.set');
        $this->post('password/set', 'Auth\ResetPasswordController@set');
    }
